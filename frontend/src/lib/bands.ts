...
export const BANDS: readonly Band[] = [
    { id: 'optimal', label: 'Optimal', min: 85, light: '#009E73', dark: '#3FC9A2', glyph: '●' },
    { id: 'good', label: 'Good', min: 70, light: '#0072B2', dark: '#5AA9E6', glyph: '◐' },
    { id: 'fair', label: 'Fair', min: 60, light: '#E69F00', dark: '#F2B84B', glyph: '○' },
    { id: 'attention', label: 'Pay attention', min: 0, light: '#D55E00', dark: '#F07F3C', glyph: '▲' },
] as const;
